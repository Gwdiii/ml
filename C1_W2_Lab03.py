...
for i in range(m): yp[i] = np.dot(X_norm[i], w_norm) + b_norm
...
print(f"predicted price of a house with 1200 sqft, 3 bedrooms, 1 floors, 40 years old = ${x_house_predict * 1000:0.0f}")
