...
from lab_utils_uni import plt_house_x,\
                          plt_contour_wgrad,\
                          plt_divergence,\
                          plt_gradients
...
# regression to fit the dta points in x and y
...
def gradient_descent(x,
    ...
    # An array to stoe cost J and w's at each iteration
